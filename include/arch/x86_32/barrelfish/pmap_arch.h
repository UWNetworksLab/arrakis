...
#ifndef ARCH_X86_32_BARRELFISH_PMAP_H
#define ARCH_X86_32_BARRELFISH_PMAP_H
...
{
    return pmap_x86_32_init(pmap, vspace, vnode, opt_slot_alloc);
}

static inline errval_t pmap_current_init(bool init_domain)
{
    return pmap_x86_32_current_init(init_domain);
}

#endif // ARCH_X86_32_BARRELFISH_PMAP_H
