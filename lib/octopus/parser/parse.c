...
{
       0,     0,     3,     5,     8,    12,    17,    19,    21,    23,
      25,    27,    31,    35,    38,    41,    44,    47,    50,    53,
      56,    59,    62,    64,    66,    68,    70,    72
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      26,     0,    -1,    27,    -1,    28,    17,    -1,    28,     5,
       6,    -1,    28,     5,    29,     6,    -1,    21,    -1,    15,
      -1,    24,    -1,    22,    -1,    30,    -1,    30,     8,    29,
      -1,    21,     7,    32,    -1,    21,    31,    -1,     9,    32,
      -1,    10,    32,    -1,    11,    32,    -1,    12,    32,    -1,
      13,    32,    -1,    14,    32,    -1,     7,    22,    -1,     7,
      15,    -1,    21,    -1,    23,    -1,    20,    -1,    18,    -1,
      19,    -1,    24,    -1
};
...
{
  "$end", "error", "$undefined", "RBRACKET", "LBRACKET", "RCURLY",
  "LCURLY", "COLON", "COMMA", "GT", "GE", "LT", "LE", "EQ", "NE",
  "VARIABLE", "EUNEXPECTED", "END_OF_INPUT", "BOOL", "FLOAT", "NUMBER",
  "IDENT", "REGEX", "STRING", "SCAN", "$accept", "program", "record",
  "name", "attributes", "attribute", "constraint", "value", 0
};
#endif
...
{
       0,     7,     6,     9,     8,     0,     2,     0,     1,     0,
       3,     4,     0,     0,    10,     0,     0,     0,     0,     0,
       0,     0,    13,     5,     0,    21,    25,    26,    24,    22,
      20,    23,    27,    12,    14,    15,    16,    17,    18,    19,
      11
};
...
{
      -3,   -14,   -14,   -14,   -14,     3,   -14,    -4,   -14,    -6,
     -14,   -14,    13,    -2,     6,   -13,    10,    10,    10,    10,
      10,    10,   -14,   -14,    -5,   -14,   -14,   -14,   -14,   -14,
...
{
      11,     9,    25,     8,    23,    26,    27,    28,    29,    30,
      31,    32,     1,    10,    24,    12,    12,    40,     2,     3,
      15,     4,    16,    17,    18,    19,    20,    21,    26,    27,
      28,    29,     0,    31,    32,    34,    35,    36,    37,    38,
      39
};

static const yytype_int8 yycheck[] =
{
       6,     5,    15,     0,     6,    18,    19,    20,    21,    22,
      23,    24,    15,    17,     8,    21,    21,    24,    21,    22,
       7,    24,     9,    10,    11,    12,    13,    14,    18,    19,
      20,    21,    -1,    23,    24,    16,    17,    18,    19,    20,
      21
};
...
{
       0,    15,    21,    22,    24,    26,    27,    28,     0,     5,
      17,     6,    21,    29,    30,     7,     9,    10,    11,    12,
      13,    14,    31,     6,     8,    15,    18,    19,    20,    21,
      22,    23,    24,    32,    32,    32,    32,    32,    32,    32,
      29
};
