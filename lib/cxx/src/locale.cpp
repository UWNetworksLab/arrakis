...
#define strcoll_l(a,b,c)	strcoll(a,b)
...
#define iswctype_l(a,b,c)	iswctype(a,b)
#define iswspace_l(a,b)		iswspace(a)
#define iswprint_l(a,b)		iswprint(a)
#define iswcntrl_l(a,b)		iswcntrl(a)
#define iswupper_l(a,b)		iswupper(a)
#define iswlower_l(a,b)		iswlower(a)
#define iswalpha_l(a,b)		iswalpha(a)
#define iswdigit_l(a,b)		iswdigit(a)
#define iswpunct_l(a,b)		iswpunct(a)
#define iswxdigit_l(a,b)	iswxdigit(a)

#define towupper_l(a,b)		towupper(a)
#define towlower_l(a,b)		towlower(a)
#define btowc_l(a,b)		btowc(a)
#define wctob_l(a,b)		wctob(a)
#define wcsnrtombs_l(a,b,c,d,e,f)	wcsnrtombs(a,b,c,d,e)
#define wcrtomb_l(a,b,c,d)	wcrtomb(a,b,c)
#define mbsnrtowcs_l(a,b,c,d,e,f)	mbsnrtowcs(a,b,c,d,e)
#define mbrtowc_l(a,b,c,d,e)	mbrtowc(a,b,c,d)
#define mbtowc_l(a,b,c,e)	mbtowc(a,b,c)
#define mbrlen_l(a,b,c,d)	mbrlen(a,b,c)
#define strftime_l(a,b,c,d,e)	strftime(a,b,c,d)
#define mbsrtowcs_l(a,b,c,d,e)	mbsrtowcs(a,b,c,d)

// XXX: Fake it to always return #MB_CUR_MAX for the C locale
#define MB_CUR_MAX_L(a)		1
